...
$total = $row['Total'];
	 ...
	 $query1= @mysql_query("Update inventory set Quantity1='$quantity1', Price1='$price1', Total ='$total' where ProductCode='$productcode'");
	 }else if($quantity1 != 0 && $price1 == $price){
	  $quantity1= $quantity + $quantity1;
	 $price1 = $price;
	  $total = $total + $quantity;
	 $query1= @mysql_query("Update inventory set Quantity1='$quantity1', Price1='$price1', Total='$total' where ProductCode='$productcode'");
	 }else if($quantity1 != 0 && $price1 != $price && $quantity2 == 0){
	   $quantity2= $quantity;
	 $price2 = $price;
	  $total = $total + $quantity;
	 $query2= @mysql_query("Update inventory set Quantity2='$quantity2', Price2='$price2', Total='$total'  where ProductCode='$productcode'");
	 }else if($quantity1 != 0 && $price1 != $price && $quantity2 != 0 && $price2 == $price){
	   $quantity2= $quantity + $quantity2;
	 $price2 = $price;
	  $total = $total + $quantity;
	 $query2= @mysql_query("Update inventory set Quantity2='$quantity2', Price2='$price2', Total='$total' where ProductCode='$productcode'");
	 }else if($quantity1 != 0 && $price1 != $price && $quantity2 != 0 && $price2 != $price && $quantity3 == 0){
	   $quantity3= $quantity;
	 $price3 = $price;
	  $total = $total + $quantity;
	 $query3= @mysql_query("Update inventory set Quantity3='$quantity3', Price3='$price3', Total='$total' where ProductCode='$productcode'");
	 }else if($quantity1 != 0 && $price1 != $price && $quantity2 != 0 && $price2 != $price && $quantity3 != 0 && $price3 == $price){

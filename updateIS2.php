...
$update1 = @mysql_query("Update inventory set Quantity1='$qtyleft1', Total='$totalleft1' where ProductCode='$description1' ");
...
$update2 = @mysql_query("Update inventory set Quantity1='$qtyleft2', Total='$totalleft2' where ProductCode='$description2' ");
...
$update3 = mysql_query("Update inventory set Quantity1='$qtyleft3', Total='$totalleft3' where ProductCode='$description3' ");
...
$update4 = mysql_query("Update inventory set Quantity1='$qtyleft4', Total='$totalleft4' where ProductCode='$description4' ");
...
$update5 = mysql_query("Update inventory set Quantity1='$qtyleft5', Total='$totalleft5' where ProductCode='$description5' ");
...
$update6 = mysql_query("Update inventory set Quantity1='$qtyleft6', Total='$totalleft6' where ProductCode='$description6' ");
...
$update7 = mysql_query("Update inventory set Quantity1='$qtyleft7', Total='$totalleft7' where ProductCode='$description7' ");
...
$update8 = mysql_query("Update inventory set Quantity1='$qtyleft8', Total='$totalleft8' where ProductCode='$description8'");
...
$update9 = mysql_query("Update inventory set Quantity1='$qtyleft9', Total='$totalleft9' where ProductCode='$description9' ");
...
$update10 = mysql_query("Update inventory set Quantity1='$qtyleft10', Total='$totalleft10' where ProductCode='$description10' ");
...
$update11 = @mysql_query("Update inventory set Quantity1='$qtyleft11', Total='$totalleft11' where ProductCode='$description11' ");

...
<script language="javascript" src="printss.js?1234" > </script>
...
<script language="javascript" src="multiplyqtyyy.js?1234567890" > </script>
...
OldBal : <input type="text" name="oldbal" id="oldbal" value="0" style="border:none " size="7" onKeyUp= "getBalance()" />

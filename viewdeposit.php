...
<legend><em style="color:#0000CC ">Form to view deposits made</em> </legend>
<form action="viewdeposits.php" method="post" name="viewdeposit"> 
</br>
<center>
...
<input type="submit" name="viewdeposit" id="viewdeposit" value="Click to View Deposits" />
</center>
</div>
</br>
<div>
